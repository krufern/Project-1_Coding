...
file_menu.add_command(label="ออก", command=exit_program)
...
base_options.config(font=("Arial", 12), bg="#ffffff")
base_options.pack(pady=5)

# กรอกค่าตัวเลข
entry_num = tk.Entry(root, font=("Arial", 12), width=20, bg="#ffffff")
entry_num.pack(pady=5)

# ปุ่มแปลงค่า
convert_button = tk.Button(root, text="แปลงค่า", font=("Arial", 12), command=convert_number, bg="#4CAF50", fg="white", width=15)
convert_button.pack(pady=5)

# ปุ่มเคลียร์ข้อมูล
clear_button = tk.Button(root, text="เคลียร์", font=("Arial", 12), command=clear_fields, bg="#f44336", fg="white", width=15)
